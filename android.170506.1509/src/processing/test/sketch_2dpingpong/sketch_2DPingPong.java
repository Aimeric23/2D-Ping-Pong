package processing.test.sketch_2dpingpong;
...
public class sketch_2DPingPong extends PApplet {
...
public void centerLine()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_2DPingPong" };
    if (passedArgs != null) {
